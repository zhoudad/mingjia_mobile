...
export default class Developer extends Component {
  ...
  render() {
    return (
        <View style={{flex:1,}}>
        <ScrollView style={{flex:1,paddingHorizontal:px(30)}}>
        ...
        <View style={{height:px(100),flexDirection:'row'}}>
          <TouchableOpacity style={{backgroundColor:'#EFFFCC',flex:1,justifyContent: 'center',alignItems: 'center',}}>
            <Text style={{color:'#303133',fontSize:px(28)}}>进入碧桂园农业</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{backgroundColor:'#FFF1D3',flex:1,justifyContent: 'center',alignItems: 'center',}}>
